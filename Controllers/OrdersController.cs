...
namespace CoffeeBranch.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        {
            var coffeeDbContext = _context.Order.Include(o => o.Branch).Include(o => o.Menu);
        ...
        public async Task<IActionResult> Create([Bind("ID,BranchId,MenuId,CustomerName")] Order order)
        {
            ...
            ViewData["BranchId"] = new SelectList(_context.Branch, "Id", "Id", order.BranchId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,BranchId,MenuId,CustomerName")] Order order)
        {
            if (id != order.ID)
            {
                return NotFound();
